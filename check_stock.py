...
def check_search_count():
    ...
    print("Productos encontrados en busqueda: " + str(current_count))
    ...
    if last_count is not None and current_count != last_count:
        if current_count > last_count:
            notify("ALERTA: Aumentaron los productos Ascended Heroes en busqueda (" + str(last_count) + " -> " + str(current_count) + "). Revisa: " + SEARCH_URL)
        else:
            notify("ALERTA: Bajaron los productos Ascended Heroes en busqueda (" + str(last_count) + " -> " + str(current_count) + "). Revisa: " + SEARCH_URL)
